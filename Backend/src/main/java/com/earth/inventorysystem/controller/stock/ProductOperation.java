...
public class ProductOperation {
    ...
    public Map<String, Object> incresestock(@RequestParam int stock_id, @RequestParam int updateAmount) {
        ...
        try {
            ...
            PreparedStatement preparedStatement = connection.prepareStatement("UPDATE stock SET amount = amount + ? WHERE stock_id = ?");
    ...
    public Map<String, Object> buying(@RequestParam int stock_id, @RequestParam int amount, @RequestParam int user_id) {
        ...
        try {
            connection = MySqlConnection.getConnection();
            preparedStatement = connection.prepareStatement("INSERT into  update (date,amount,user_id,stock_id) values (?,?,?,?) ");
